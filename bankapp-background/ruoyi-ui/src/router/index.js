...
export const constantRoutes = [
  ...
  }, 
  {
    ...
    children: [
      {
        path: 'account/index',
        component: () => import('@/views/bank/account/index'),
        name: 'account',
        meta: { title: '个体用户', activeMenu: '/bank' }
      }
    ]
  },
    {
    ...
    children: [
      {
        path: 'paccount/index',
        component: () => import('@/views/bank/paccount/index'),
        name: 'paccount',
        meta: { title: '公司用户', activeMenu: '/bank' }
      }
    ]
  },
   {
    ...
    children: [
      {
        path: 'transfer_money/index',
        component: () => import('@/views/bank/transfer_money/index'),
        name: 'transfer_money',
        meta: { title: '转账', activeMenu: '/bank' }
      }
    ]
  },
   {
    ...
    children: [
      {
        path: 'user_information/index',
        component: () => import('@/views/bank/user_information/index'),
        name: 'user_information',
        meta: { title: '用户信息', activeMenu: '/bank' }
      }
    ]
  },
]
